...
export function GaugeChartComponent({ value, maxValue = 800, title }: GaugeProps) {
            ...
            series: [
                ...
                } as GaugeSeriesOption,
                {
                    ...
                    detail: {
                        ...
                        rich: {
                            value: { fontSize: "1.3333rem", fontWeight: 500, color: "#1D1D1D" },
                            unit: { fontSize: "1rem", fontWeight: 400, color: "#555", padding: [0, 0, -2, -2] },
                        },
                    },
                    data: [{ value }],
                } as GaugeSeriesOption,
    ...
    return (
        <div style={{ position: 'relative', width: 136, height: 136, margin: '0 auto' }}>
            ...
            <IconComponent name="power" size={60} styles={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', marginTop: -8 }} />
        </div>
    );
}
